...
public:
	...
	void setTexture(float* data) {
		bind();
		glTexSubImage3D(GL_TEXTURE_2D_ARRAY, 0, 0, 0, 0, width, height , LayerN, GL_RED, GL_FLOAT, data);
	}
